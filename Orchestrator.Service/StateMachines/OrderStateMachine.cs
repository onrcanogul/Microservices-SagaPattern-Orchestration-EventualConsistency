    ...
    public class OrderStateMachine : MassTransitStateMachine<OrderStateInstance>
    {
        ...
        public OrderStateMachine()
        {
            ...
            Event(() => OrderStartedEvent,
                //this orderid exist or ?
                orderStateInstance => orderStateInstance.CorrelateBy<Guid>(database => database.OrderId, @event =>  Guid.Parse(@event.Message.OrderId))
                .SelectId(e => Guid.NewGuid())); // new correlationid
            ...
            Initially(When(OrderStartedEvent)
                .Then(context =>
                {
                    //orderstateinstance
                    //context.Instance --> DB
                    //context.Data --> Datas on events
                    context.Instance.OrderId =  Guid.Parse(context.Data.OrderId);
                    context.Instance.BuyerId = Guid.Parse(context.Data.BuyerId);
            ...
            During(StockReserved,
                ...
                {
                    OrderId = context.Instance.OrderId.ToString()
                })
                .Finalize(),
